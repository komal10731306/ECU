...
uint16_t randominput(uint16_t Min,uint16_t Max)
{
...
void handle_client(int client_socket) 
{
    ...
    bool flag=0;
    quantity_Carbon_monoxide=randominput(Min,Max);
    printf("Quantity of Carbon monoxide in %dppm\n",quantity_Carbon_monoxide);
    
    Nitrogen_oxide=randominput(Min,Max);
    printf("Quantity of Carbon monoxide in %dppm\n",Nitrogen_oxide);
    
    Hydro_Carbons=randominput(Min,Max);
    printf("Quantity of Carbon monoxide in %dppm\n",Hydro_Carbons);
    printf("\n");
    char text1[1024];
